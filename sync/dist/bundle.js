...
var ActorProxy = /** @class */ (function () {
    ...
    ActorProxy.sendAndReturn = function (mailbox, actorId, methodName, args) {
        return new Promise(function (resolve, reject) {
            return mailbox.push(message.default.of(actorId, actorMessage.default.of(methodName, args, resolve, reject)));
        });
    };
    ActorProxy.of = function (mailbox, actor$1) {
        var allNames = [];
        var _loop_1 = function (o) {
            allNames = allNames.concat(Object.getOwnPropertyNames(o).filter(function (a) { return typeof o[a] === 'function'; }));
        };
        for (var o = actor$1; o !== actor.default.prototype; o = Object.getPrototypeOf(o)) {
            _loop_1(o);
        }
        return allNames
            ...
            function () {
                ...
                return ActorProxy.sendAndReturn(mailbox, actor$1.id, name, args);
            },
        ]; })
            .reduce(function (result, _a) {
            var _b;
            var member = _a[0], method = _a[1];
            return (tslib_es6.__assign(tslib_es6.__assign({}, result), (_b = {}, _b[member] = method, _b)));
        }, { ref: actor$1 });
    };
    return ActorProxy;
}());
...
var ActorSystem = /** @class */ (function () {
    ...
    ActorSystem.prototype.actorOf = function (classFn, values) {
        var instance = new (classFn.bind.apply(classFn, tslib_es6.__spreadArrays([void 0], values)))();
...
var vue_1 = tslib_es6.__importDefault(Vue);
...
var VueRenderer = /** @class */ (function () {
    ...
    VueRenderer.prototype.onInitialize = function (actor) {
        ...
        var methods = Object.keys(localActor.constructor.prototype).filter(function (key) { return typeof localActor.constructor.prototype[key] === 'function' && key !== 'constructor'; });
        localActor.__internals = localActor.__internals || {};
        localActor.__internals.vue = new vue_1.default({
            data: data,
            el: "#" + localActor.id,
            methods: toObject(methods.map(function (method) { return ({ name: method, fn: localActor.self[method] }); })),
            template: template,
        });
    };
    ...
    return /** @class */ (function (_super) {
        ...
        function class_1(params) {
            ...
            decorators.forEach(function (decorator) {
                var instance = new decorator(_this);
                var allNames = Object.getOwnPropertyNames(Object.getPrototypeOf(instance)).filter(function (name) { return name !== 'constructor'; });
                allNames.forEach(function (name) {
                    if (!_this.constructor.prototype[name])
                        _this.constructor.prototype[name] = function () {
                            var parameters = [];
                            for (var _i = 0; _i < arguments.length; _i++) {
                                parameters[_i] = arguments[_i];
                            }
                            return instance[name].apply(instance, parameters);
                        };
                });
            });
            return _this;
...
var VueDecorated = /** @class */ (function (_super) {
    __extends(VueDecorated, _super);
    function VueDecorated(actor) {
        return _super.call(this, actor) || this;
    }
    VueDecorated.prototype.increment = function () {
        this.actor.self.addOne();
    };
    VueDecorated.prototype.template = function () { return '<div id="app"><button v-on:click="increment">{{this.actor.counter}}</button></div>'; };
    VueDecorated.prototype.data = function () {
        return this;
    };
    return VueDecorated;
}(dist_2$2));
var Serialization = /** @class */ (function (_super) {
    ...
    Serialization.prototype.updateFrom = function (_a) {
...
var RemoteResolverMaterializer_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

var axios_1 = tslib_es6.__importDefault(axios$1);
var RemoteResolverMaterializer = /** @class */ (function () {
    function RemoteResolverMaterializer(config) {
        var _this = this;
        this.resolvedActors = new Set();
        this.config = config;
        setInterval(function () { return _this.updateFromBackend(); }, config.sync.delay);
    }
    RemoteResolverMaterializer.prototype.onInitialize = function (actor) {
        //
    };
    RemoteResolverMaterializer.prototype.onBeforeMessage = function (actor, message) {
        //
    };
    RemoteResolverMaterializer.prototype.onAfterMessage = function (actor, message) {
        return tslib_es6.__awaiter(this, void 0, void 0, function () {
            var _a, _b, _c;
            return tslib_es6.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _c = [this.config.paths.push + "/" + actor.id];
                        return [4 /*yield*/, actor.toJson()];
                    case 1:
    ...
    RemoteResolverMaterializer.prototype.onError = function (actor, message, error) {
        //
    };
    RemoteResolverMaterializer.prototype.resolveActorById = function (id) {
        return tslib_es6.__awaiter(this, void 0, void 0, function () {
            var result, actor;
            return tslib_es6.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.get(this.config.paths.pull + "/" + id)];
                    case 1:
                        result = _a.sent();
                        actor = new this.config.actorTypes[result.data.type](id);
                        actor.updateFrom(result.data);
                        this.resolvedActors.add(actor);
                        return [2 /*return*/, Promise.resolve(actor)];
                }
            });
        });
    };
    RemoteResolverMaterializer.prototype.updateFromBackend = function () {
        var _this = this;
        this.resolvedActors.forEach(function (actor) {
            return axios_1.default.get(_this.config.paths.pull + "/" + actor.id).then(function (result) { return actor.updateFrom(result.data); });
        });
    };
    return RemoteResolverMaterializer;
}());
exports.RemoteResolverMaterializer = RemoteResolverMaterializer;
});
...
window.onload = function () {
    system
        .actorFor("app")
        .catch(function () { return Promise.resolve(system.actorOf(DecoratedActor, ["app"])); });
};
