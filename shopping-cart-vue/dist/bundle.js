...
var Stock = /** @class */ (function (_super) {
    ...
    Stock.prototype.loadProducts = function () {
    ...
    Stock.prototype.reserveProduct = function (product) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                ...
                foundProduct.stock--;
                return [2 /*return*/, __assign({}, foundProduct)];
            });
        });
    };
    return Stock;
}(dist_1));
var StockProtocol = /** @class */ (function (_super) {
    __extends(StockProtocol, _super);
    function StockProtocol() {
        return _super.call(this) || this;
    }
    StockProtocol.prototype.onStockChanged = function (products) { };
...
var ShoppingCartProtocol = /** @class */ (function (_super) {
    __extends(ShoppingCartProtocol, _super);
    function ShoppingCartProtocol() {
        return _super.call(this) || this;
    }
    ShoppingCartProtocol.prototype.onCartChanged = function (items, totalPrice) { };
    return ShoppingCartProtocol;
}(dist_1));
...
var ProductListComponent = /** @class */ (function (_super) {
    ...
    ProductListComponent.prototype.onStockChanged = function (products) {
...
var ShoppingCartComponent = /** @class */ (function (_super) {
    ...
    function ShoppingCartComponent(shoppingCart, cartProtocol) {
        ...
        _this.shoppingCart = shoppingCart;
        _this.shoppingCartItems = [];
        _this.totalPrice = 0;
        _this.cartEmpty = true;
        _this.subscribeToTopic(cartProtocol);
        return _this;
    }
    ShoppingCartComponent.prototype.onCartChanged = function (items, totalPrice) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, simulateLoad(250)];
...
window.onload = function () {
    var system = dist_2.for(dist_3.define()
        ...
        .done());
    var stockProtocol = dist_4.for(system, 'stock', StockProtocol);
    var shoppingCartProtocol = dist_4.for(system, 'shopping-cart', ShoppingCartProtocol);
    var stock = system.actorOf(Stock, [stockProtocol]);
