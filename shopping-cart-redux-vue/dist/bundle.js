...
var actorMessage = createCommonjsModule(function (module, exports) {
/**
 * Copyright (c) 2018-present, tarant
 *
 * This source code is licensed under the MIT license found in the
...
unwrapExports(actorMessage);

var actorProxy = createCommonjsModule(function (module, exports) {
/**
 * Copyright (c) 2018-present, tarant
 *
 * This source code is licensed under the MIT license found in the
...
var ActorProxy = /** @class */ (function () {
    ...
    ActorProxy.sendAndReturn = function (mailbox, actorId, methodName, args) {
        return new Promise(function (resolve, reject) {
            mailbox.push(message.default.of(actorId, actorMessage.default.of(methodName, args, resolve, reject)));
        });
    };
...
var Actor = /** @class */ (function () {
    ...
    Actor.prototype.schedule = function (interval, fn, values) {
        ...
        var id = uuid.default();
        setTimeout(function () {
            var sysAny = _this.system;
            _this.scheduled.set(id, setInterval(function () { return actorProxy.default.sendAndReturn(sysAny.mailbox, _this.id, fn.name, values); }, interval));
        }, 0);
        return id;
    };
    /**
    ...
    Actor.prototype.scheduleOnce = function (timeout, fn, values) {
        ...
        setTimeout(function () {
            var sysAny = _this.system;
            _this.scheduled.set(id, setTimeout(function () {
                actorProxy.default.sendAndReturn(sysAny.mailbox, _this.id, fn.name, values);
    ...
    Actor.prototype.cancel = function (cancellable) {
        var _this = this;
        setTimeout(function () {
            var id = _this.scheduled.get(cancellable);
            clearTimeout(id);
            clearInterval(id);
            _this.scheduled.delete(cancellable);
        }, 0);
    };
    /**
    ...
    Actor.prototype.subscribeToTopic = function (topic) {
        var _this = this;
        setTimeout(function () { return tslib_es6.__awaiter(_this, void 0, void 0, function () {
            var topicSubscription;
            return tslib_es6.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, topic.subscribe(this)];
                    case 1:
                        topicSubscription = _a.sent();
    ...
    Actor.prototype.unsubscribeFromTopic = function (topic) {
        var id = this.topicSubscriptions.get(topic.id);
        if (id === undefined) {
            return;
        }
...
var fiber = createCommonjsModule(function (module, exports) {
/**
 * Copyright (c) 2018-present, tarant
 *
 * This source code is licensed under the MIT license found in the
...
var mailbox = createCommonjsModule(function (module, exports) {
/**
 * Copyright (c) 2018-present, tarant
 *
 * This source code is licensed under the MIT license found in the
...
var Mailbox = /** @class */ (function () {
    ...
    Mailbox.prototype.addSubscriber = function (subscriber) {
        ...
        partitions.forEach(function (partition) {
            ...
            _this.subscriptions[partition].push(new subscription.default(id, subscriber));
        });
        return id;
    };
    Mailbox.prototype.removeSubscription = function (subscription$$1) {
        var _this = this;
        var partitions = this.subscribedPartitions[subscription$$1];
        partitions.forEach(function (partition) { return (_this.subscriptions[partition] = _this.subscriptions[partition].filter(function (s) { return s.id !== subscription$$1; })); });
        delete this.subscribedPartitions[subscription$$1];
    };
    Mailbox.prototype.push = function (message) {
        this.subscriptions[message.partition].forEach(function (subscription$$1) { return subscription$$1.messages.push(message); });
    };
    Mailbox.prototype.poll = function (subscription$$1) {
        return tslib_es6.__awaiter(this, void 0, void 0, function () {
            var partitions;
            var _this = this;
            return tslib_es6.__generator(this, function (_a) {
                partitions = this.subscribedPartitions[subscription$$1];
                if (!partitions) {
                    return [2 /*return*/];
                }
                partitions.forEach(function (partition) {
                    return _this.subscriptions[partition]
                        .filter(function (managedSubscription) { return managedSubscription.id === subscription$$1; })
...
unwrapExports(noopSupervisor);

var actorSystemConfigurationBuilder = createCommonjsModule(function (module, exports) {
/**
 * Copyright (c) 2018-present, tarant
 *
 * This source code is licensed under the MIT license found in the
...
var ActorSystemConfigurationBuilder = /** @class */ (function () {
    function ActorSystemConfigurationBuilder() {
        ...
        this.supervisor = new noopSupervisor.default();
    }
    ...
    ActorSystemConfigurationBuilder.prototype.withMailbox = function (mailbox$$1) {
...
unwrapExports(actorSystemConfigurationBuilder);
...
var FunctionActor = /** @class */ (function (_super) {
    tslib_es6.__extends(FunctionActor, _super);
    function FunctionActor(fn) {
        var _this = _super.call(this) || this;
        _this.fn = fn;
        return _this;
    }
    FunctionActor.for = function (system, fn) {
        var actor$$1 = system.actorOf(FunctionActor, [fn]);
        // tslint:disable-next-line
        return function () {
            return actor$$1.execute.apply(actor$$1, arguments);
        };
    };
    FunctionActor.prototype.execute = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        return tslib_es6.__awaiter(this, void 0, void 0, function () {
            return tslib_es6.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fn.apply(this, args)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
...
exports.default = FunctionActor;
});

unwrapExports(_function);

var actorSystem = createCommonjsModule(function (module, exports) {
/**
 * Copyright (c) 2018-present, tarant
 *
 * This source code is licensed under the MIT license found in the
...
var ActorSystem = /** @class */ (function () {
    ...
    ActorSystem.default = function () {
        return new ActorSystem(actorSystemConfigurationBuilder.default.define().done());
    };
    ...
    ActorSystem.prototype.actorOf = function (classFn, values) {
        ...
        var proxy = actorProxy.default.of(this.mailbox, instance);
    ...
    ActorSystem.prototype.actorFor = function (id) {
        return tslib_es6.__awaiter(this, void 0, void 0, function () {
            var instance, _i, _a, resolver, _1, proxy;
            return tslib_es6.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        proxy = actorProxy.default.of(this.mailbox, instance);
                        this.setupInstance(instance, proxy);
     ...
     */
    ActorSystem.prototype.functionFor = function (fn) {
        return _function.default.for(this, fn);
    };
    /**
     ...
     */
    ActorSystem.prototype.resolveOrNew = function (id, elseClass, values) {
        return tslib_es6.__awaiter(this, void 0, void 0, function () {
            var _2;
            return tslib_es6.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.actorFor(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        _2 = _a.sent();
                        return [2 /*return*/, this.actorOf(elseClass, values)];
...
unwrapExports(actorSystem);

var topic = createCommonjsModule(function (module, exports) {
/**
 * Copyright (c) 2018-present, tarant
 *
 * This source code is licensed under the MIT license found in the
    ...
    function Topic(topicName, consumerClass) {
        ...
        props
            ...
            _this.constructor.prototype[k] = function () {
                ...
                _this.subscriptions.forEach(function (actor$$1) { return actor$$1[k].apply(actor$$1, args); });
            };
        });
        return _this;
    }
...
exports.Actor = actor.default;

exports.ActorSystem = actorSystem.default;

exports.ActorSystemConfigurationBuilder = actorSystemConfigurationBuilder.default;

exports.Topic = topic.default;

exports.ActorMessage = actorMessage.default;
});

unwrapExports(dist);
var dist_1 = dist.Actor;
var dist_2 = dist.ActorSystem;
var dist_3 = dist.ActorSystemConfigurationBuilder;
...
var Actor = /** @class */ (function () {
    ...
    Actor.prototype.schedule = function (interval, fn, values) {
        ...
        setTimeout(function () {
            var sysAny = _this.system;
            _this.scheduled.set(id, setInterval(function () { return actorProxy$2.default.sendAndReturn(sysAny.mailbox, _this.id, fn.name, values); }, interval));
        }, 0);
        return id;
    };
    /**
    ...
    Actor.prototype.scheduleOnce = function (timeout, fn, values) {
        ...
        setTimeout(function () {
            var sysAny = _this.system;
            _this.scheduled.set(id, setTimeout(function () {
                actorProxy$2.default.sendAndReturn(sysAny.mailbox, _this.id, fn.name, values);
                _this.scheduled.delete(id);
            }, timeout));
        }, 0);
        return id;
...
var _function$2 = createCommonjsModule(function (module, exports) {
/**
 * Copyright (c) 2018-present, tarant
 *
 * This source code is licensed under the MIT license found in the
...
var FunctionActor = /** @class */ (function (_super) {
    ...
    FunctionActor.for = function (system, fn) {
        var actor = system.actorOf(FunctionActor, [fn]);
        // tslint:disable-next-line
        return function () {
            return actor.execute.apply(actor, arguments);
        };
    };
    FunctionActor.prototype.execute = function () {
        var args = [];
...
var ActorSystem = /** @class */ (function () {
            ...
            return tslib_es6.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        this.actors.set(id, instance);
                        this.subscriptions.set(instance.id, this.mailbox.addSubscriber(instance));
                        proxy = actorProxy$2.default.of(this.mailbox, instance);
                        this.setupInstance(instance, proxy);
                        return [2 /*return*/, proxy];
                    case 7: return [2 /*return*/, actorProxy$2.default.of(this.mailbox, instance)];
                }
            });
        });
    };
     ...
     */
    ActorSystem.prototype.functionFor = function (fn) {
        return _function$2.default.for(this, fn);
    };
    /**
     * Tries to find an actor, if it doesn't exist, creates a new one.
     *
...
var VueActor = /** @class */ (function (_super) {
    tslib_es6.__extends(VueActor, _super);
    function VueActor() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        // tslint:disable-next-line
        _this.__isVueActor = true;
        return _this;
    }
    return VueActor;
}(dist$1.Actor));
...
unwrapExports(vueActor);
var vueActor_1 = vueActor.VueActor;
...
unwrapExports(vue_common);

var vueRenderer = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var VueRenderer = /** @class */ (function () {
    ...
    VueRenderer.prototype.onInitialize = function (baseActor) {
        if (!baseActor.__isVueActor) {
            return;
        }
        var actor = baseActor;
        ...
        var actorAsAny = actor;
        actorAsAny.__internals = actorAsAny.__internals || {};
        actorAsAny.__internals.vue = new vue_1.default({
            data: actor,
            el: "#" + actor.id,
            methods: toObject(methods.map(function (method) { return ({ name: method, fn: actorAsAny.self[method] }); })),
            template: actor.template,
        });
    };
    VueRenderer.prototype.onBeforeMessage = function (actor, message) {
        //
    };
    VueRenderer.prototype.onAfterMessage = function (actor, message) {
        //
    };
    VueRenderer.prototype.onError = function (actor, message, error) {
        //
    };
    return VueRenderer;
}());
...
exports.ActorSystem = dist$1.ActorSystem;
exports.ActorSystemConfigurationBuilder = dist$1.ActorSystemConfigurationBuilder;
...
var dist_1$2 = dist$2.ActorSystem;
var dist_2$2 = dist$2.ActorSystemConfigurationBuilder;
var dist_3$2 = dist$2.VueActor;
var dist_4$2 = dist$2.VueRenderer;

var Actions = /** @class */ (function (_super) {
    __extends(Actions, _super);
    function Actions(topic, shop) {
        var _this = _super.call(this, 'actions/products') || this;
        _this.topic = topic;
        _this.shop = shop;
        return _this;
    }
    Actions.prototype.getAll = function () {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.shop.retrieveAllProducts()];
                    case 1:
                        allProducts = _a.sent();
...
var ActionsProtocol = /** @class */ (function (_super) {
    __extends(ActionsProtocol, _super);
    function ActionsProtocol() {
...
var Shop = /** @class */ (function (_super) {
    ...
    Shop.prototype.retrieveAllProducts = function () {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var initialShoppingCartState = function () { return Object.create({ totalPrice: 0, products: [], error: undefined }); };
var ShoppingCartReducer = /** @class */ (function (_super) {
    __extends(ShoppingCartReducer, _super);
    function ShoppingCartReducer(actions, store) {
        var _this = _super.call(this, 'reducers/products') || this;
        _this.state = initialShoppingCartState();
        _this.store = store;
        _this.subscribeToTopic(actions);
        return _this;
    }
    ShoppingCartReducer.prototype.onAddToCart = function (productTitle) {
        var stock = this.state.stock.get(productTitle);
    ...
    ShoppingCartReducer.prototype.onRetrievedAllProducts = function (allProducts) {
        var _this = this;
    ...
    ShoppingCartReducer.prototype.__addProductToList = function (product) {
        var foundProduct = this.state.products.filter(function (p) { return p.product.title === product.title; });
        var base = foundProduct.length > 0 ? foundProduct[0] : { product: product, totalPrice: 0, count: 0 };
        base.count++;
        base.totalPrice = base.count * base.product.price;
        this.state.products = this.state.products.filter(function (p) { return p.product.title !== product.title; }).concat(base);
    };
    ShoppingCartReducer.prototype.__updateTotalPrice = function () {
        this.state.totalPrice = this.state.products.map(function (product) { return product.totalPrice; }).reduce(function (a, b) { return a + b; }, 0);
    };
    ShoppingCartReducer.prototype.__updateStockOf = function (stock) {
...
var initialProductReducerState = function () { return Object.create({ stock: new Map(), error: undefined }); };
var ProductReducer = /** @class */ (function (_super) {
    __extends(ProductReducer, _super);
    function ProductReducer(actions, store) {
        var _this = _super.call(this, 'reducers/products') || this;
        _this.state = initialProductReducerState();
        _this.store = store;
        _this.subscribeToTopic(actions);
        return _this;
    }
    ProductReducer.prototype.onAddToCart = function (productTitle) {
        var stock = this.state.stock.get(productTitle);
        if (stock !== undefined && stock.stock > 0) {
    ...
    ProductReducer.prototype.onRetrievedAllProducts = function (allProducts) {
        var _this = this;
        this.state.stock = new Map();
        allProducts.forEach(function (product) { return _this.state.stock.set(product.title, { product: product, stock: product.quantity }); });
        this.store.propagateState('products', this.state);
...
var Store = /** @class */ (function (_super) {
    ...
    Store.prototype.propagateState = function (stateName, state) {
        this.state[stateName] = state;
        this.topic.onStoreChanged(this.state);
    };
    return Store;
}(dist_1));
var StoreProtocol = /** @class */ (function (_super) {
    __extends(StoreProtocol, _super);
    function StoreProtocol() {
        return _super.call(this) || this;
    }
    StoreProtocol.prototype.onStoreChanged = function (state) { };
    return StoreProtocol;
}(dist_1));

var ProductList = /** @class */ (function (_super) {
    __extends(ProductList, _super);
    function ProductList(store, actions) {
    ...
    ProductList.prototype.onStoreChanged = function (state) {
        var _this = this;
        this.products = [];
        state.products.stock.forEach(function (productInfo) {
            _this.products = _this.products.concat([{ title: productInfo.product.title, price: productInfo.product.price, stock: productInfo.stock }]);
        });
    };
...
window.onload = function () {
    var system = dist_2.for(dist_3.define()
        .withMaterializers([new dist_4$2()])
        .done());
    var storeProtocol = dist_4.for(system, 'store', StoreProtocol);
    var store = system.actorOf(Store, [storeProtocol]);
    var shop = system.actorOf(Shop, []);
    var actionsProtocol = dist_4.for(system, 'actions', ActionsProtocol);
